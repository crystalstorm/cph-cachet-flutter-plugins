...
//                    HKMetadataKeyIndoorWorkout: true,
            ...
            if(value > 0) {
                ...
                sample = HKWorkout(
                    activityType: activityType, // TODO: should be possible to change the activity from the Flutter side
                    start: dateFrom,
                    end: dateTo,
                    workoutEvents: nil,
                ...
                sample =  HKWorkout(activityType: activityType, start: dateFrom, end: dateTo)
            }
        }
        else {
